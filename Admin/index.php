...
<?php include_once('includes/header.php'); ?>  
    <a href="add_event.php" class="badge badge-primary" style="padding:9px">Add New Event</a> <br/><br/>
...
<tbody>
    ...
    <div class="header">
    <a href="add_ticket.php" class="badge badge-primary" style="padding:9px">Add New Tickets</a> <br/><br/>
</div>
<?php
